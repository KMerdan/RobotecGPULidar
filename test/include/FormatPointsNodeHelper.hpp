...
struct FormatPointsNodeHelper
{
	...
	FormatPointsNodeHelper() : formatNodes(MULTIPLE_FORMATS_COUNT, nullptr) {}
	...
	struct PointTriplePadding
	{
		...
		static std::vector<rgl_field_t> getPointFields()
		{
			return {XYZ_F32, PADDING_32, IS_HIT_I32, PADDING_32, DISTANCE_F32, PADDING_32};
		}
	};

	struct PointQuadrPadding
	{
		Field<PADDING_32>::type padding;
		Field<XYZ_F32>::type xyz;
		Field<PADDING_32>::type padding2;
		...
		static std::vector<rgl_field_t> getPointFields()
		{
			return {PADDING_32, XYZ_F32, PADDING_32, IS_HIT_I32, PADDING_32, DISTANCE_F32, PADDING_32};
		}
	};
